...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast ([7 x i32]* @main.arr to i8*), i64 28, i32 16, i1 false)
  store i32 7, i32* %3, align 4
  %5 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i32 0, i32 0
  %6 = load i32, i32* %3, align 4
  call void @bubbleSort(i32* %5, i32 %6)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0))
  %8 = getelementptr inbounds [7 x i32], [7 x i32]* %2, i32 0, i32 0
